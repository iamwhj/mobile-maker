<template>
  ...
  <el-form :model="form">
    <el-form-item label="宽度：">
      <el-input-number v-model="form.width" :min="0" :max="240" controls-position="right" />
      <SuffixCharacter />
    </el-form-item>
...
import SuffixCharacter from '../suffixCharacter'
import { getCurrentComponet, updateComponent } from '@mk/editor-helper'
...
watch(form, () => {
  updateComponent({ newDetail: form, key: 'style' })
})
</script>
