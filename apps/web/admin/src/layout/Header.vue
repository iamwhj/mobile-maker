<template>
  <div class="topBar">
    <div class="menu-controll" @click="changeMenuCollapse">
      ...
      >
        <el-icon :size="22" @mouseenter="tooltipVisible = true" @mouseleave="tooltipVisible = false">
    ...
    <div class="right-info">
      <div class="github">
        <a href="//github.com/iamwhj/mobile-maker" target="_blank">
          <img
            src="//github.com/iamwhj/picx-images-hosting/raw/master/mobile-maker/96cbdd469ebf2a8bed92fe4c0f6bcea6.5xany121jx.webp"
            title="can you star"
          />
          <span>仓库</span>
        </a>
