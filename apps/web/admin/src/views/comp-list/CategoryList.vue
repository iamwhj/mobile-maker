<template>
  <div class="category-list">
    <el-button type="primary" class="add-btn" @click="addVisible = true"> 添加分类 </el-button>
...
<script setup>
import { ref } from 'vue'
import { getCategoryList, saveCategory, updateCategory, deleteCategory } from '@mk/api'
